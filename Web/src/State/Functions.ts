...
export const objectMap = <T, R>(obj: Record<string, T>, fn: (key: string, value: T) => R) =>
...
export const resetStates = (state: Record<string, { resetState: () => void }>) =>
  Object.values(state).map((a) => a.resetState())
